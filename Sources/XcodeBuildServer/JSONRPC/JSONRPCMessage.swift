...
public enum JSONRPCMessage {
    ...
    case request(any RequestType, id: RequestID)
    case response(ResponseType, id: RequestID)
    case errorResponse(ResponseError, id: RequestID?)
}

public extension CodingUserInfoKey {
    static let responseTypeCallbackKey: CodingUserInfoKey = .init(
        rawValue: "lsp.jsonrpc.responseTypeCallback"
    )!
    static let messageRegistryKey: CodingUserInfoKey = .init(rawValue: "lsp.jsonrpc.messageRegistry")!
}
