...
public enum XcodeProductType: String, Codable, Sendable, Hashable {
    case none = ""
    ...
    public var fileExtension: String? {
        ...
        case .unitTestBundle, .uiTestBundle:
            "xctest"
        case .appExtension, .extensionKitExtension, .tvExtension, .watchExtension, .watch2Extension, .messagesExtension,
             .stickerPack, .xcodeExtension,
