...
public struct CompilerArgumentsProvider: Sendable {
    ...
    public func compileArguments(for fileURL: URL? = nil) -> [String] {
...
extension CompilerArgumentsProvider {
    static let commonMappings: [CompilerFlagMapping] = [
        ...
        ) { $0.split(separator: " ").map { ["-arch", String($0)] }.flatMap(\.self) },
        CompilerFlagMapping(
            buildSetting: "HEADER_SEARCH_PATHS",
            appliesTo: [.swift, .clang]
        ) { $0.split(separator: " ").map { ["-I", String($0)] }.flatMap(\.self) },
        CompilerFlagMapping(
            buildSetting: "FRAMEWORK_SEARCH_PATHS",
            appliesTo: [.swift, .clang]
        ) { $0.split(separator: " ").map { ["-F", String($0)] }.flatMap(\.self) },
        CompilerFlagMapping(
            buildSetting: "LIBRARY_SEARCH_PATHS",
            appliesTo: [.clang]
        ) { $0.split(separator: " ").map { ["-L", String($0)] }.flatMap(\.self) }
    ]
    ...
    static let swiftMappings: [CompilerFlagMapping] = [
        ...
        CompilerFlagMapping(
            ...
            appliesTo: [.swift]
        ) { $0.split(separator: " ").map { ["-D", String($0)] }.flatMap(\.self) },
        CompilerFlagMapping(
