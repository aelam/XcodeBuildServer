...
struct LineTests {
    @Test
    func resolveLineShopProduct() async throws {
        guard ProcessInfo.processInfo.environment["CI"] == nil else {
            return
        }

        let targetName = "LineShopProduct"
        let fileSubPath = "LineShopProduct/Bundle+LineShopProduct.swift.swift"
        let projectFolder = URL(fileURLWithPath: "/Users/wang.lun/Work/line-ios")
        let projectFilePath = projectFolder
            .appendingPathComponent("LineShopProduct.xcodeproj").path
